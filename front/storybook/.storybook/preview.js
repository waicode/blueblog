...
import { TITLE_DEFAULT, DESCRIPTION_MAP, DESCRIPTION, useMetaDescription } from '@/composables/descriptions';
import { useArticlesState } from '@/composables/state';
import { default as useCss } from '@/composables/useCss';
import { default as useOgp, OG_TITLE, OG_TYPE, OG_DESCRIPTION, OG_IMAGE } from '@/composables/useOgp';
...
import { default as useWebFont, FONT_TYPE_MAP, FONT_WEIGHT_MAP, FONT_WEIGHT_TYPE } from '@/composables/useWebFont';
